...
ACR_NAME=""
LOCATION=""
LOCAL_IMAGE_NAME="langgraph_api"
LOCAL_IMAGE_NAME_TAG="latest"
IMAGE_APP_PORT_NUMBER=4001 # Port number on which the app is running inside the container
CONTAINERAPP_ENV_NAME="langgraph-env"
